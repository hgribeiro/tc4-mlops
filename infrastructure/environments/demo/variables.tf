...
variable "low_quota_mode" {
  description = "Approved default while this account has 10 Lambda concurrent executions: omit reserved concurrency. Set false only after quota approval to reserve 2 executions."
  type        = bool
  default     = true
}
